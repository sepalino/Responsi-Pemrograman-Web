...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-V0mb2yqN.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Dn42cEBx.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-vg5J004h.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, navigateTo as a, useRuntimeConfig as b, withoutTrailingSlash as c, resolveUnrefHeadInput as d, hasProtocol as h, injectHead as i, joinURL as j, nuxtLinkDefaults as n, parseQuery as p, resolveRouteObject as r, server as s, useRouter as u, withTrailingSlash as w };
